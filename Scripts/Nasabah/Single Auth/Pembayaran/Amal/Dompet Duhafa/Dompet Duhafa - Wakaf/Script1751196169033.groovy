...
CustomKeywords.'custom.helper.setDestinationFolder'('/Users/irwan/Documents/screenshots/Pembayaran/Amal/Dompet Dhuafa - Wakaf')
...
CustomKeywords.'object.dropdown.amal'('Wakaf')

CustomKeywords.'custom.helper.Screenshoot'()

WebUI.click(findTestObject('Nasabah/Pembayaran/Amal/Dropdown_Pilih Nominal'))

CustomKeywords.'object.dropdown.Nominal'('50000')
