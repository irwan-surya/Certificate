...
WebUI.sendKeys(findTestObject('Object Repository/Admin/Pengaturan Pengguna/Admin1/input_email'), Email_Existting)
...
WebUI.verifyElementText(findTestObject('Admin/Pengaturan Pengguna/Admin1/text/text_Email sudah tersedia'), 'Email sudah tersedia')
